# Naturo Surfaces App - PySide6 with Either-Or Search (Code or Questionnaire) - Resized Layout
...
class SearchTab(QWidget):
    def __init__(self, root_dir):
        ...
        splitter.setSizes([300, 800])  # Larger preview
