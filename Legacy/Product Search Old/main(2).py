...
class SearchTab(QWidget):
    def __init__(self, root_dir):
        ...
        # Label to show active filters
        self.active_filters_label = QLabel("")
        self.active_filters_label.setStyleSheet("font-weight: bold; padding: 4px;")
        ...
        # Internal cart to track cart items added from search tab
        self._cart_items = []
